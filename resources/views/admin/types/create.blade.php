        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="container mt-3">
                    <form id="addUser" action="{{ route('admin.storeTypes') }}" autocomplete="off" method="post" enctype="multipart/form-data">
                        @csrf
                        <div id="successMessage" style="color: green; margin-top: 15px;"></div>
                        <div class="form-group">
                            <label for="floatingfirst">Type:</label>
                            <input type="text" class="form-control" name="type" placeholder="Enter type" value="{{ old('type') }}">
