        ...
        <header class="tg-header__style-five">
            ...
            <!--                    @else-->
            <!--                        <li>-->
            <!--                            <a href="{{ route('front.login') }}" class="btn-login">Login</a>-->
            <!--                        </li>-->
            <!--                    @endif-->
            <!--                </ul>-->
            <!--            </div>-->
            ...
            <div id="sticky-header" class="tg-header__area tg-header__area-five">
                <div class="container1 ms-4">
                    <div class="row">
                        <div class="col-12">
                            <div class="tgmenu__wrap">
                                <nav class="tgmenu__nav">
                                    <div class="logo">
                                        <a href="{{ url('/') }}"><img src="{{url($pageData->logo_image)}}" alt="Logo" /></a>
                                    </div>
                                        ...
                                        <ul class="navigation">
                                            ...
                                            @foreach($types as $type)
                                                <li class="menu-item-has-children">
                                                    <a href="{{ route('admin.viewBlog', ['slug' => $type->slug]) }}">{{ $type->type }}</a>
                                                    @if(isset($mainCategories[$type->id]))
                                                        <ul class="sub-menu">
                                                                    ...
                                                                    @if($main->children->count())
                                                                        <ul class="sub-menu">
                                                                            @foreach($main->children as $sub)
                                                                                <li><a href="{{ $sub->slug ? route('category.innerSubCategory', ['parentSlug' => $main->slug, 'slug' => $sub->slug]) : '#' }}">{{ $sub->name }}</a></li>
                                                                            @endforeach
                                                                        </ul>
                                                                    @endif
                                                                </li>
